...
**Division Example:** Lets say I want to divide 117 by 12 and find the quotient, I can do it in NeoHaskell like this
...
**Power Example:** Lets say I want to find what we will get by cubing five (five raised to the power of three), I can do it in NeoHaskell as shown
