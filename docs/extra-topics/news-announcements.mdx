...
<details>
  ...
  **GitHub Issues:**
  ...
  - [ ] [Issue #70](https://github.com/neohaskell/neohaskell/issues/70) — All Neo (sub)commands should have a help command that explains how to use it properly
  - [ ] [Issue #133](https://github.com/neohaskell/neohaskell/issues/133) — Initialize projects with neo init
