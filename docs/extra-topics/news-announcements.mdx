...
<details>
  ...
  **GitHub Issues:**
  ...
  - [ ] [Issue #126](https://github.com/neohaskell/neohaskell/issues/126) — Move forEach from Array to Task to Avoid Cyclic Dependency
  ...
  - [ ] [Issue #138](https://github.com/neohaskell/neohaskell/issues/138) — Research how to provide a REPL using the Nix environment, rather than cabal
